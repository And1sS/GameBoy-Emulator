...
IMPL_INSTR(C6, regs[A_REG] = add_instr(regs[A_REG], read_d8(), false)          , 8)			// ADD A, d8
...
IMPL_INSTR(CE, regs[A_REG] = add_instr(regs[A_REG], read_d8(), false)          , 8)			// ADC A, d8
...
IMPL_INSTR(D6, regs[A_REG] = sub_instr(regs[A_REG], read_d8(), false)          , 8)			// SUB A, d8
...
IMPL_INSTR(DE, regs[A_REG] = sub_instr(regs[A_REG], read_d8(), true)           , 8)			// SBC A, d8
...
IMPL_INSTR(E6, regs[A_REG] = and_instr(regs[A_REG], read_d8())                 , 8)			// AND A, d8
...
IMPL_INSTR(F6, regs[A_REG] = or_instr(regs[A_REG], read_d8())                  , 8)			// OR A, d8
...
IMPL_INSTR(EE, regs[A_REG] = xor_instr(regs[A_REG], read_d8())                 , 8)			// XOR A, d8
...
IMPL_INSTR(FE, cp_instr(regs[A_REG], read_d8())                                , 8)			// CP A, d8
...
// LD INSTRUCTIONS
IMPL_INSTR(3E, regs[A_REG] = read_d8()                                         , 8)         // LD A, d8
IMPL_INSTR(06, regs[B_REG] = read_d8()                                         , 8)         // LD B, d8
IMPL_INSTR(0E, regs[C_REG] = read_d8()                                         , 8)         // LD C, d8
IMPL_INSTR(16, regs[D_REG] = read_d8()                                         , 8)         // LD D, d8
IMPL_INSTR(1E, regs[E_REG] = read_d8()                                         , 8)         // LD E, d8
IMPL_INSTR(26, regs[H_REG] = read_d8()                                         , 8)         // LD H, d8
IMPL_INSTR(2E, regs[L_REG] = read_d8()                                         , 8)         // LD L, d8
IMPL_INSTR(36, write_to_HL(read_d8())                                          , 12)        // LD (HL), d8
...
IMPL_INSTR(F0, regs[A_REG] = mem->read_byte(0xFF00 + read_d8())                , 12)        // LD A, (FF00 + a8)
IMPL_INSTR(E2, mem->write_byte(0xFF00 + regs[C_REG], regs[A_REG])              , 8)         // LD (FF00 + C), A 
IMPL_INSTR(E0, mem->write_byte(0xFF00 + read_d8(), regs[A_REG])                , 12)        // LD (FF00 + a8), A 
