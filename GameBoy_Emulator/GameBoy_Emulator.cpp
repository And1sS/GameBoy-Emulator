...
int main()
{
	...
	mem->write_bytes(0x100, { 0x00, 0xC3, 0x50, 0x01 });

	// Load Nintendo logo
	mem->write_bytes(0x104,
	{
...
void draw_screen(PPU& ppu, CPU& cpu)
{
	...
	for (int i = 0; i < height; i++)
	{
		...
		{
			switch (ppu.get_screen_buffer()[i][j])
			{
			case 0:
				screen[i * width + j] = ' ';
				break;
			...
			case 1:
				screen[i * width + j] = 0x2592;
				break;

			case 2:
				screen[i * width + j] = 0x2593;
				break;

			case 3:
				screen[i * width + j] = 0x2588;
				break;
			}
		}
	}
